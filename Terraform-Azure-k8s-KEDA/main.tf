...
# - Azure Container Registry
 - Azure Storage Account, Storage queue 
#
# ----------------------------------------------------
...
resource "azurerm_container_registry" "azacr10" {
  name                     = "azacr10"
...
#----------------------------------------------------
# azurerm_storage_account , azurerm_storage_queue
#----------------------------------------------------
 
resource "azurerm_storage_account" "azstorageaccnt01" {
  name                     = "azstorageaccnt01"
  location                 = azurerm_resource_group.resource_group.location
  resource_group_name      = azurerm_resource_group.resource_group.name
...
resource "azurerm_storage_queue" "az-strorage-queue01" {
  name                 = "az-strorage-queue01"
  storage_account_name = azurerm_storage_account.azstorageaccnt01.name
}
